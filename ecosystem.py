...
class Ecosystem:
    ...
    def simulate_day(self, energy_food: float = 10.0) -> None:
        """
        Симулирует один день: каждый живой организм получает энергию.

        :param energy_food: количество энергии, получаемой за день
        """
    ...
    def __str__(self) -> str:
        return (
            f"Экосистема: {len(self.organisms)} организмов, "
            f"живых: {self.get_alive_count()}"
        )
